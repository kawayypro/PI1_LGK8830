...
public class Test {
	...
	public static void main(String[] args) {
		...
		for(cont = 1; cont<=3; cont++) {
			System.out.println("Test " + cont.toString() + "\n");
			System.out.println("Solucion iterativa : " + Ejercicio3.ejercicio3Iterativo("src/ficheros/PI1Ej3DatosEntrada" 
			+ cont.toString() + "A.txt", "src/ficheros/PI1Ej3DatosEntrada" + cont.toString() + "B.txt"));
			
			System.out.println("Solucion RecursivaF: " + Ejercicio3.ejercicio3RecursivoFinal("src/ficheros/PI1Ej3DatosEntrada" 
			+ cont.toString() + "A.txt", "src/ficheros/PI1Ej3DatosEntrada" + cont.toString() + "B.txt"));
			
			System.out.println("Solucion Funcional : " + Ejercicio3.ejercicio3Funcional("src/ficheros/PI1Ej3DatosEntrada" + cont.toString() 
			+ "A.txt", "src/ficheros/PI1Ej3DatosEntrada" + cont.toString() + "B.txt") + "\n");
		}
